...
public class Sentiment_Analysis123 extends Configured implements Tool {
...
/*
...

	{
		...
		ToolRunner.run(new Sentiment_Analysis123(), args);
	...
	public int run(String[] args) throws Exception {
		...
		args = new String[] { "/user/guru/tweets/FlumeData.1510889807092","tmp5"};

		//DistributedCache.addCacheFile(new URI("/AFINN.txt"), conf);

		Job job = new Job(conf, "SentimentAnalysis");

		job.setJarByClass(Sentiment_Analysis123.class);
